...
public class JobTest {
    ...
    public void createJobObjects() {
        ...
        jobWithSomeMissingFields = new Job("Product tester", new Employer(""), new Location("Desert"), new PositionType("Quality control"), new CoreCompetency("Persistence"));
    }
    ...
    public void testJobConstructorSetsAllFields() {
        ...
        assertEquals(jobWithAllFields.getEmployer().getValue(), "ACME");
        assertEquals(jobWithAllFields.getLocation().getValue(), "Desert");
        assertEquals(jobWithAllFields.getPositionType().getValue(), "Quality control");
        assertEquals(jobWithAllFields.getCoreCompetency().getValue(), "Persistence");
    }

    @Test
    public void testJobsForEquality() {
        assertNotEquals(jobWithAllFields, jobWithAllFields2);
    }
